...
public class WQU_PathCompression12 {

    private int n;
    private int[] arr;
    private int[] sz;

    public WQU_PathCompression12(int n) {
        this.n = n;
        arr = new int[n];
        sz = new int[n];
    ...
    public void union(int x, int y) {
        ...
        System.out.println("Union Operation: " + "(" + x + "," + y + ")" + " Integer Array: " + Arrays.toString(arr) + " Size Array:" + Arrays.toString(sz));
    }
    ...
    public static void main(String[] args) {
        ...
        WQU_PathCompression12 test = new WQU_PathCompression12(10);
